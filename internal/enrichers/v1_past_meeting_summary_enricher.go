...
// V1PastMeetingSummaryEnricher handles V1 past meeting summary-specific enrichment logic
type V1PastMeetingSummaryEnricher struct {
	defaultEnricher Enricher
}

// ObjectType returns the object type this enricher handles.
func (e *V1PastMeetingSummaryEnricher) ObjectType() string {
	return e.defaultEnricher.ObjectType()
}

// EnrichData enriches V1 past meeting summary-specific data
func (e *V1PastMeetingSummaryEnricher) EnrichData(body *contracts.TransactionBody, transaction *contracts.LFXTransaction) error {
...
func (e *V1PastMeetingSummaryEnricher) setAccessControl(body *contracts.TransactionBody, data map[string]any, objectType, objectID string) {
	...
	// Set access control with V1 past meeting summary-specific logic
...
// NewV1PastMeetingSummaryEnricher creates a new V1 past meeting summary enricher
func NewV1PastMeetingSummaryEnricher() Enricher {
	enricher := &V1PastMeetingSummaryEnricher{}
