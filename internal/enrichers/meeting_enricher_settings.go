...
// MeetingSettingsEnricher handles meeting-specific enrichment logic
type MeetingSettingsEnricher struct{}

// NewMeetingSettingsEnricher creates a new meeting enricher
func NewMeetingSettingsEnricher() *MeetingSettingsEnricher {
	return &MeetingSettingsEnricher{}
}

// ObjectType returns the object type this enricher handles
func (e *MeetingSettingsEnricher) ObjectType() string {
	return constants.ObjectTypeMeetingSettings
}
...
func (e *MeetingSettingsEnricher) EnrichData(body *contracts.TransactionBody, transaction *contracts.LFXTransaction) error {
	...
	// Extract meeting UID using 'uid' field (matches reference implementation)
	...
	// A meeting's settings are not public for any meeting visibility
	body.Public = false
