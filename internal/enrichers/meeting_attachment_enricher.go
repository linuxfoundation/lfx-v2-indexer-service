...
// MeetingAttachmentEnricher handles meeting-attachment-specific enrichment logic
type MeetingAttachmentEnricher struct {
	defaultEnricher Enricher
}

// ObjectType returns the object type this enricher handles.
func (e *MeetingAttachmentEnricher) ObjectType() string {
	return e.defaultEnricher.ObjectType()
}

// EnrichData enriches meeting-attachment-specific data
func (e *MeetingAttachmentEnricher) EnrichData(body *contracts.TransactionBody, transaction *contracts.LFXTransaction) error {
	return e.defaultEnricher.EnrichData(body, transaction)
}

// setAccessControl provides meeting-attachment-specific access control logic
// Attachment objects inherit permissions from their parent meeting
func (e *MeetingAttachmentEnricher) setAccessControl(body *contracts.TransactionBody, data map[string]any, objectType, objectID string) {
	...
	// Set access control with meeting-attachment-specific logic
...
// extractNameAndAliases extracts the name and aliases from the meeting attachment data
func (e *MeetingAttachmentEnricher) extractNameAndAliases(data map[string]any) []string {
...
// NewMeetingAttachmentEnricher creates a new meeting attachment enricher
func NewMeetingAttachmentEnricher() Enricher {
	enricher := &MeetingAttachmentEnricher{}
